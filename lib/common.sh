...
function help(){
    ...
    echo "  -pubk|--pubKey          Public key of node (Optional)"
    echo "  -pkA|--privKeyA         Private key A of node (Optional)"
    echo "  -pubkA|--pubKeyA        Public key Aof node (Optional)"
    echo "NOTE if not all 4 keys are provided, node keys will be generated"
    echo ""
    echo "E.g."
