...
function help(){
    ...
    echo ""
    echo "Utility to setup Lition Network"
    echo ""
    echo "Commands:"
    echo -e $GREEN'create'$COLOR_END    "           Create a new Node. The node hosts Lition side chain, Constellation and Node Manager"
    echo -e $PINK'join as validator'$COLOR_END       "Create a node and Join as validator to existing Lition side chain network"
    echo -e $BLUE'join'$COLOR_END     "             Create a node and Join to existing Lition side chain network"
    echo ""
    echo "Options:"
    echo ""
    ...
    echo ""
    echo "E.g."
    echo "./setup.sh join_as_validator -n slave1 --oip 10.0.2.15 --onm 22004 --tip 10.0.2.15 -r 23000 -w 23001 -c 23002 --nm 23004 --ws 23005"
    echo ""
    ...
    echo ""
    echo "E.g."
    echo "./setup.sh join -n slave1 --oip 10.0.2.15 --onm 22004 --tip 10.0.2.15 -r 23000 -w 23001 -c 23002 --nm 23004 --ws 23005"
    echo ""
